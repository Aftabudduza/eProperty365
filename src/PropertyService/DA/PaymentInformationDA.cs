...
namespace PropertyService.DA
{
    public class PaymentInformationDA
    {
        ...
        public PaymentInformation GetCheckingAccountByOwner(string ownerId)
        {
            PaymentInformation obj = null;
            try
            {
                var empQuery = from b in objPropertyEntities.PaymentInformation
                               where b.OwnerId == ownerId && b.IsCheckingAccount == true
                               select b;
        ...
        //public int Insert(PaymentInformation obj)
        //{
        //    try
        //    {
