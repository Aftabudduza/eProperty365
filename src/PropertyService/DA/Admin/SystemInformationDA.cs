...
{
    public class AdminSystemInformationDA
    {
        PropertyEntities objPropertyEntities = null;
        public AdminSystemInformationDA(bool isLazyLoadingEnable = true)
        {
            objPropertyEntities = PropertyEntity.GetEntity();
            objPropertyEntities.Configuration.LazyLoadingEnabled = isLazyLoadingEnable;
        }

        public AdminSystemInformationDA(bool isNewContext, bool isLazyLoadingEnable = true)
        {
            if (isNewContext)
        ...
        {
            SystemInformation objGlobal = null;
            try
            {
                ...
                objGlobal = empQuery.ToList().FirstOrDefault();
