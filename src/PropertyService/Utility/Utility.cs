...
{
    //private volatile static EPropertyEntities singleTonObject;
    ...
    public static string CONNECTIONSTRINGNEW
    {
        get
        {
            try
            {
                return Convert.ToString(System.Configuration.ConfigurationSettings.AppSettings["ConnectionStringNew"].ToString());
            }
            catch (Exception ex)
            {
    ...
    //        try
    //        {
    //            return Convert.ToString(System.Configuration.ConfigurationSettings.AppSettings["Model"].ToString());
    //        }
    //        catch (Exception ex)
    //        {
    ...
    private static void disconnectNew()
    {
        if (!CONNECTIONSTRINGNEW.Equals("") && conn != null)
        {
            try
            {
                conn.Close();
    ...
    public static bool RunCMD(string sql)
    {
        SqlCommand cmd;
