<%@ Page Title="EProperty365: Admin Dashboard" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DashboardAdmin.aspx.cs" Inherits="eProperty.Pages.DashboardAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#btnView', function (parameters) {
            ...
            var URL = "/Pages/DashboardAdmin.aspx/" + "GetStatusReport";
            var obj = {
                "UnitId": UnitId,
                "SerialId": TenantId
            }
