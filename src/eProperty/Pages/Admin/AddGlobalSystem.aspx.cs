    ...
    public partial class AddGlobalSystem : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                SystemInformation objSystem = new AdminSystemInformationDA().GetGlobalInfo();
                if (objSystem != null)
                {
                    ...
                    if(objSystemInformation != null)
                    {
                        ...
                        if (Session["AddSystemId"] == null || Session["AddSystemId"].ToString() == "0")
                        {
                            if (new AdminSystemInformationDA().Insert(objSystemInformation))
                            {
                                ...
                                Utility.DisplayMsgAndRedirect("System Information Created successfully!", this, Utility.WebUrl + "/Pages/Account/SalesPartnerDealerDashboard.aspx");
                        ...
                        else
                        {
                            if (new AdminSystemInformationDA().Update(objSystemInformation))
                            {
                                ...
                                Utility.DisplayMsgAndRedirect("System Information updated successfully!", this, Utility.WebUrl + "/Pages/Account/SalesPartnerDealerDashboard.aspx");
                            }
                            else
                            {
        ...
        protected void btnEditCard_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(hdId.Text))
            {
                PaymentInformation obj = new AdminPaymentInformationDA().GetByID(Convert.ToInt32(hdId.Text));
                if (obj != null)
                {
        ...
        //protected void cvChargeBackValidator_OnServerValidate(object sender, ServerValidateEventArgs e)
        //{
        //    e.IsValid = Convert.ToInt32(e.Value.ToString()) >= 50;
        //}
        //protected void cvLateFeeValidator_OnServerValidate(object sender, ServerValidateEventArgs e)
        //{
        //    e.IsValid = Convert.ToInt32(e.Value.ToString()) >= 5;
        //}
        #endregion
        #region Method
        ...
        private SystemInformation SetData(SystemInformation obj)
        {
            try
            {
                ...
                {
                    obj = new AdminSystemInformationDA().GetByID(Convert.ToInt32(Session["AddSystemId"]));
                ...
                if (Session["Username"] != null)
                {
                    if (Session["Username"].ToString() != string.Empty)
                    {
                        ...
                        //obj = new AdminSystemInformationDA().GetByUsername(Session["Username"].ToString());
                        //if(obj != null)
                ...
                //{
                 //   SystemInformation obj = new SystemInformationDA().GetByID(nId);
                    if (obj != null)
                    {
                        ...
                        if (string.IsNullOrEmpty(obj.DocumentLink))
                        {
        ...
        private void FillCardGrid()
        {
            try
            {
                ...
                if (Session["Username"] != null)
                {
                    objPayments = new AdminPaymentInformationDA().GetByUsername(Session["Username"].ToString());
                }
