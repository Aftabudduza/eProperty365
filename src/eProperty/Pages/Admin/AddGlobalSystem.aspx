<%@ Page Title="EProperty365: Global System Info" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AddGlobalSystem.aspx.cs" Inherits="eProperty.Pages.Admin.AddGlobalSystem" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel8">
            <ContentTemplate>
                <div class="box">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border CommonHeader col-md-12">
                                <h3 class="box-title" id="lblHeadline" runat="server">Eproperty 365 Global System Information</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="box-header with-border CommonHeader col-md-12">
                            <h3 class="box-title">Default Pricing</h3>
                        </div>
                        <div class="box-body">
                            <div class="col-md-6">
                            ...
                            <ContentTemplate>
                                <div class="box-body">
                                    <div class="col-md-4" style="float: left; padding: 0px; padding-top: 10px; margin-right: 15px; background-color: #8B9DC3;">
                                        <div class="col-sm-12">
                                            <asp:GridView Width="100%" ID="gvContactTypeList" runat="server" AutoGenerateColumns="False" CellPadding="10" ForeColor="#333333" CssClass="table table-responsive"
