<%@ Page Title="EProperty365: Create / Change Residential Web Page Specs Options Unit" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AddResidentialUnit2.aspx.cs" Inherits="eProperty.Pages.Admin.AddResidentialUnit2" %>
                                        ...
                                        <div class="col-md-12">
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="col-md-6" style="float: left;">
                                                        <label class="col-sm-6 control-label">User can turn background On/Off:</label>
                                                        <div class="col-sm-6">
                                                            <asp:RadioButtonList runat="server" ID="rdoScreening" RepeatDirection="Horizontal">
