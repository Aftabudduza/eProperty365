<%@ Page Title="EProperty365: Create / Change Residential Web Page Specs Options Unit" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="AddResidentialUnit_old.aspx.cs" Inherits="eProperty.Pages.Admin.AddResidentialUnitold" %>
        ...
        <div class="box">
            <asp:UpdatePanel runat="server" ID="topPanel">
                <ContentTemplate>
                    ...
                    <div class="box-body">
                        <fieldset>
                            <asp:GridView Width="100%" ID="gvUnitList" runat="server" AutoGenerateColumns="False" CellPadding="10" ForeColor="#333333" CssClass="table table-bordered table-striped"
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-6">
                                <asp:DropDownList ID="ddlPropertyManagerID" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPropertyManagerID_SelectedIndexChanged">
                                </asp:DropDownList>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left: 5px; float: left">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select id="ddlSendMassageTo" class="form-control ddl loadCoun col-sm-12"></select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="text-align: center; float: left">
                                                        <div class="form-group">
                                                            ...
                                                            <label style="margin-right: 7px">
                                                                <input type="radio" name="r5" value="Report Issue to the Manager" class="flat-red">
                                                        ...
                                                        <table id="tblDocumentFileList" class="table table-responsive table-bordered table-striped">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style='width: 15%'>Default Status </th>
                                ...
                                <ContentTemplate>
                                    <div class="box">
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="box-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <label class="col-sm-4 control-label" style="color:red;">Image size needs to be 205x177x72</label>
                                                            </div>
                                                            <div class="row" style="display: none;">
                                        ...
                                        <div class="col-md-12 btnSaveWebCenter">
                                            ...
                                            <div class="col-md-6" style="float: left">
                                                <input type="button" value="Create Unit Web Page" id="createWebPage" class="btn btn-successnew " />
                                            </div>
                                        </div>
                                          <div class="col-md-12 btnSaveWebCenter">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10" style="padding-left: 3px;">
                                                        <div class="form-group">
                                                            ...
                                                            <label style="margin-right: 7px">
                                                                <input type="radio" name="r3" value="Dealer" id="Dealer" class="flat-red">
                                                                Dealer
                                                            </label>
                                                            <label style="margin-right: 7px">
                                                                <input type="radio" name="r3" value="Agent" class="flat-red">
                                                                Agent
                                                            </label>
                                                            <label style="margin-right: 7px">
                                                                <input type="radio" name="r3" value="Unknown" class="flat-red">
                                                                Unknown
                                                            </label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <label style="margin-right: 7px">
                                                                <input type="radio" name="r4" value="No Warrenty" class="flat-red">
                                                                No Warrenty
                                                            </label>
                                    ...
                                    <div class="box">
                                        <div class="col-md-12">
                                            <div class="box box-primary">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4" style="float: left">
                                                        <label for="txtTotalApplicationFees" class="col-sm-6 control-label">Total Application Fees:</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" id="txtTotalApplicationFees" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4" style="float: left">
                                                        <label for="txtMTDShowings" class="col-sm-6 control-label">MTD Showings:</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" id="txtMTDShowings" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4" style="float: left">
                                                        <label for="txtMTDViews" class="col-sm-6 control-label">MTD Views:</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" id="txtMTDViews" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4" style="float: left">
                                                        <label for="txtTotalShowings" class="col-sm-6 control-label">Total Showings:</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" id="txtTotalShowings" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4" style="float: left">
                                                        <label for="txtTotalViews" class="col-sm-6 control-label">Total Views:</label>
                                                        <div class="col-sm-6">
                                                            <input type="text" id="txtTotalViews" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
    ...
    <script type="text/javascript">
                        ...
                        if (result.d == '') {
                            ...
                            if (lstofRentalDocumentData.length > 0) {
                                $.each(lstofRentalDocumentData, function (i, obj) {
                                    ...
                                    content += "<td style='width:30%'> <input style='float: left;'  type='file' class='form-control' id='fileRentalDocument' /><input  type='button' style='margin-left: 4px;margin-top: 5px;' value='Browse Site Library' data_RowId='" + obj.Id + "' class='btn btnNewColor' onclick='BrowseSiteLibrary(this);' /> <input  type='button' style='margin-left: 4px;margin-top: 5px;' value='Upload' data_RowId='" + obj.Id + "' class='btn btnNewColor' onclick='SaveRentalImage(this);' /></td>"; //DateAdded
                                ...
                                content += "<td style='width:35%'> <input  type='file' style='float: left;' style='width: 230px;float: left;' class='form-control' id='fileRentalDocument' /><input  type='button' style='margin-left: 4px;margin-top: 5px;' value='Browse Site Library' data_RowId='0' class='btn btnNewColor' onclick='BrowseSiteLibrary(this);' /> <input type='button' style='margin-top:2px;' value='Upload' data_RowId='0' style='width: 24%;margin-left: 4px;margin-top: 5px;' class='btn btnNewColor' onclick='SaveRentalImage(this);' /></td>";//DateAdded
        ...
        $(document).off('click', '.btnAdd').on('click', '.btnAdd', function () {
            ...
            if (checkitemsave > 0) {
                ...
                content += "<td style='width:20%'> <textarea  data_RowId='0' id='txtDocumentDesc' rows='3' cols='5' class='form-control'></textarea></td>";
                content += "<td style='width:15%'><input type='text' id='RentalDocFileName' class='form-control' value=''></td>";//DateAdded
                content += "<td style='width:35%'> <input  type='file' style='float: left;width: 74%;'  class='form-control fileRentalDocument' id='fileRentalDocument' /> <input type='button' style='width: 24%;margin-left: 4px;margin-top: 5px;' value='Upload' data_RowId='0' class='btn btnNewColor' onclick='SaveRentalImage(this);' /><input disabled type='button' value='Browse Site Library' onclick='BrowsSiteLiabery(this)' class='custombtn'/></td>";//DateAdded
        ...
        function SaveRentalImage(currrenttd) {
            ...
            if ($($($(trRow).find('td:eq(3)').children())[0]).val() != "") {
                ...
                var extFile = fileName.substr(idxDot, fileName.length).toLowerCase();
                G_ImageName = extFile;
                if (extFile == "jpg" || extFile == "jpeg" || extFile == "png" || extFile == 'gif' || extFile == 'tiff' || extFile == 'pdf') {
                    //TO DO
                    var reader = new FileReader();
                    ...
                    //alert("Only .gif, .jpg, .png, .tiff and .jpeg are allowed!");
                    notify('danger', "Only .gif, .jpg, .png, .tiff, .jpeg , .pdf are allowed!");
        ...
        function UpdateFilesEq_Rental(evt) {
            ...
            if (validationLessDocument(curentRow)) {
                ...
                //   
                //    //console.log(result);
                //    ImageSave = result.replace("data:application/vnd.openxmlformats-officedocument.wordprocessingml.document;base64,", "");
                //    //ImageSave = result;
        ...
        $(document).on('change', '#txtWebAnalyticsfTo', function (parameters) {
            ...
            var From = $("#txtWebAnalyticsfFrom").val();
            var To = $("#txtWebAnalyticsfTo").val();
            ...
            $.ajax({
                ...
                success:
                    function (result) {
                        ...
                        if (Message[0] != null)
                        {
                            if (Message[0].TotalApplicationFees != null && Message[0].TotalApplicationFees != '')
                                $('#txtTotalApplicationFees').val(parseFloat(Message[0].TotalApplicationFees));

                            if (Message[0].MTDShowings != null && Message[0].MTDShowings != '')
                                $('#txtMTDShowings').val(parseFloat(Message[0].MTDShowings));

                            if (Message[0].TotalShowings != null && Message[0].TotalShowings != '')
                                $('#txtTotalShowings').val(parseFloat(Message[0].TotalShowings));

                            if (Message[0].MTDViews != null && Message[0].MTDViews != '')
                                $('#txtMTDViews').val(parseFloat(Message[0].MTDViews));

                            if (Message[0].TotalViews != null && Message[0].TotalViews != '')
                                $('#txtTotalViews').val(parseFloat(Message[0].TotalViews));
