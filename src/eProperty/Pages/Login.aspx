<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Login.aspx.cs" Inherits="eProperty.Pages.Login" %>
...
<![endif]-->
    ...
    <title>EProperty365 Portal :: Login</title>
</head>
<body class="login" style="background-color: #fff;">
                    ...
                    <form id="form1" runat="server" class="form-vertical">
                        <div class="control-group-merged">
                            <div class="control-group" style="background: #fff;">
                                <asp:TextBox ID="txtEmail" placeholder="Enter Email Address" runat="server" CssClass="span12 required input-username bg_input"></asp:TextBox>
                        ...
                        <div class="control-group">
                            <asp:Button ID="btnLogin" runat="server" Text="Sign In" OnClick="btnLogin_Click"  OnClientClick="CheckVal()"  CssClass="btn btn-success btn-block btn-large"  ValidationGroup="Login" Style="margin-left: 0px;"  />
                        </div>
                        <div class="control-group">
                            <asp:Button ID="btnRegister" runat="server" Text="Create an Account First Time Sign In" OnClick="btnRegister_Click" OnClientClick="CheckVal()" CssClass="btn btn-success btn-block btn-large"  ValidationGroup="Login" Style="width: 100%; margin-left: 0px; float: none;" />
                        </div>
                        <div class="clearfix"></div>
                        <div class="separator" style="margin-top: 20px;">
                            <div class="login_footer" style="text-align:center;">
                                <h1 style="margin-bottom: 20px;"><i class="fa fa-paw"></i>Eproperty365
                                </h1>
                                <p>Copyright &copy; <span id="spanYear" runat="server"></span><a style="margin-left: 5px;" target="_blank" href="https://www.eproperty365.com/">Eproperty365</a>. All rights reserved.</p>
  ...
  <%--  <script src="../Content/plugins/uniform/jquery.uniform.min.js"></script>--%>
   ...
   <script type="text/javascript">
       ...
       //    var AccountType = parseInt($('#ddlAccountType').val());
       //    if (!isNaN(AccountType)) {
       //        if (AccountType === 3 || AccountType === 5 || AccountType === 6 || AccountType === 7)
       //        {
       //            $("#divOwner").show();
       //        }
       //        else {
