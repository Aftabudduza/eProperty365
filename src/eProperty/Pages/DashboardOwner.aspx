<%@ Page Title="EProperty365: Owner Dashboard" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="DashboardOwner.aspx.cs" Inherits="eProperty.Pages.DashboardOwner" %>
            ...
            <div class="col-md-12">
                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                    <ContentTemplate>
                                    ...
                                    <div class="box box-primary">
                                        <div class="row">
                                            <div class="col-md-4" style="float: left">
                                                <label class="col-sm-6 control-label">No Property:</label>
                                                <div class="col-sm-6">
                                                    <asp:Label ID="lblProperty" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-4" style="float: left">
                                                <label for="lblYTDIncome" class="col-sm-6 control-label">YTD Income:</label>
                                                <div class="col-sm-6">
                                                    $<asp:Label ID="lblYTDIncome" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-4" style="float: left">
                                                <label for="lblYTDExpenses" class="col-sm-6 control-label">YTD Expenses:</label>
                                                <div class="col-sm-6">
                                                    $<asp:Label ID="lblYTDExpenses" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4" style="float: left">
                                                <label class="col-sm-6 control-label">No Unit's:</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="col-md-4" style="float: left">
                                                <label for="lblMTDIncome" class="col-sm-6 control-label">MTD Income:</label>
                                                <div class="col-sm-6">
                                                    $<asp:Label ID="lblMTDIncome" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-4" style="float: left">
                                                <label for="lblMTDExpenses" class="col-sm-6 control-label">MTD Expenses:</label>
                                                <div class="col-sm-6">
                                                    $<asp:Label ID="lblMTDExpenses" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box-footer">
                                    <div class="col-md-12">
                                        ...
                                        <input type="button" id="btnView" value="View Credit / Background Screening" class="btn btn-success" />
                        ...
                        <div class="box" id="divXMLStatus" style="display: none">
                            <div class="col-md-12">
                                <div class="box box-primary">
                                    <div class="box-header with-border CommonHeader col-md-12">
                                        <h3 class="box-title">XML Status Report</h3>
                                    </div>
                                    <div class="box-body">
                                        <div class="col-md-12">
                                            <table id="tblXMLStatus" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>Report Status
                                                        </th>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#btnView', function (parameters) {
            var UnitId = $('input[id$=hdnUnitSerial]').val();
            var TenantId = $('input[id$=hdnAppId]').val();

            var URL = "/Pages/DashboardOwner.aspx/" + "GetStatusReport";
            var obj = {
                "UnitId": UnitId,
                "SerialId": TenantId
            }
            ...
            Basic.then((data) => {
                if (data.d != null || data.d != "") {
                    var myResult = JSON.parse(data.d);
                    debugger;
                    if (myResult != null) {
                        var content = "";
                        var url = "";
                        if (myResult.Status != "error") {
                            url = "<a href='" + myResult.ReportURl + "' target='_blank'>" + myResult.ReportURl + "</a>";
                        }
                        else {
                            url = myResult.ReportURl;
                        }
                        content += "<tr>";
                        content += "<td>";
                        content += myResult.Status;
                        content += "</td>";
                        content += "<td>";
                        content += url;
                        // content += "<a href='" + url + "' target='_blank'>" + myResult.ReportURl + "</a>";
                        content += "</td>";
                        content += "</tr>";
                        $("#tblXMLStatus tbody").empty();
                        $("#tblXMLStatus tbody").append(content);
                        $("#divXMLStatus").show();
                    }
                }
            });
