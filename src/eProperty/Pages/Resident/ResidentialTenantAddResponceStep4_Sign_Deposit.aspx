<%@ Page Title="EProperty365: Residential Tenant Step 4 Sign & Pay Deposit" Language="C#" AutoEventWireup="true" CodeBehind="ResidentialTenantAddResponceStep4_Sign_Deposit.aspx.cs" Inherits="eProperty.Pages.Resident.ResidentialTenantAddResponceStep4_Sign_Deposit" %>
                                                                ...
                                                                <div style="margin: 5px 20px; width: 93%; float: left;">
                                                                            ...
                                                                            <table style="font-size: 11px; float: left; width: 100%; background-color: white; margin-bottom: 20px; margin-top: 20px;" cellspacing="2" cellpadding="5" border="1">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                           <%-- <input type="text" class="tDate" id="txtDueDate" />--%>
                                                                    ...
                                                                    <div style="width: 100%; background-color: #DFE3EE; margin-top: 20px; border: 1px solid black; float: left; padding: 10px; display: none" id="tblCash">
                                                                        ...
                                                                        <div style="float: left; width: 100%; text-align: center; margin-top: 20px; margin-bottom: 20px;">
                                                                            ...
                                                                            <input type="hidden" id="hdnFeeType" value="<%=sFeeType%>" />
                                                                            <input type="hidden" id="hdnFlat" value="<%=sFlatFee%>" />
                                                                            <input type="hidden" id="hdnPercentage" value="<%=sPercentFee%>" />
                                                                        </div>
                                                                    </div>
