...
{
    public partial class ResidentialTenantAddResponceStep4_Sign_Depositold : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string DocImageUpload(string Image, string ImageName, string DocId, string CurrentStatus)
        {
            if (HttpContext.Current.Session["ResidentialUnitSerial"] == null &&
               string.IsNullOrEmpty(HttpContext.Current.Session["ResidentialUnitSerial"]?.ToString()))
                return "";
