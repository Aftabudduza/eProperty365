<%@ Page Title="EProperty365: Residential Tenant rental Application Page 4" Language="C#" MasterPageFile="~/MasterPage/RentalAddMaster.Master" AutoEventWireup="true" CodeBehind="ResidentialTenantRental_App_Page_4.aspx.cs" Inherits="eProperty.Pages.Resident.ResidentialTenantRental_App_Page_4" %>
                ...
                <table style="font-size: 11px; float: left; width: 100%; background-color: white; margin-bottom: 20px;" cellspacing="2" cellpadding="5" border="1">
                    <tbody>
                        <tr>
                            <td style="width: 42%"><span style="width: 100%; float: left">Enter Document Description</span>
                                <span style="width: 100%; float: left;">
                                    <input type="text" id="txtAddiDoc" class="form-control" /></span>
                            </td>
                            <td>
                                <span>
            ...
            <tbody>
                <tr>
                    <td style="width: 50%;">
                        ...
                        <input type="button" class="btn btnNewColor" id="btnExit" style="background-color: #3B5998; float:right;" value="Exit" />
