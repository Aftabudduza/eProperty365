<%@ Page Title="EProperty365: Tenant Profile" Language="C#" MasterPageFile="~/MasterPage/Site.master" AutoEventWireup="true" CodeBehind="TenantProfile_DashBoard.aspx.cs" Inherits="eProperty.Pages.Resident.TenantProfile_DashBoard" %>
            ...
            <div class="box box-primary">
                <div class="row">
                    <div class="box-header with-border CommonHeader col-md-12" style="margin-top: 0px;">
                        <h3 class="box-title" id="H1" runat="server">Tenant Profile</h3>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
                                ...
                                <tbody style="padding: 5px;">
                                    ...
                                    <tr>
                                        <td style="" colspan="3">
                                            ...
                                            <input type="text" id="txtAliasName" style="width: 63%" />
                            ...
                            runat="server" ></asp:TextBox>--%>
                                    ...
                                    <tr>
                                        <td style="">
                                            ...
                                            <input type="text" id="txtMobilePhone" style="width: 55%" />


                                        </td>
                                        <td style="" colspan="2">
                                            <span>Home Phone #:</span>
                                            <input type="text" id="txtHomePhone" style="width: 70%" />
                                    ...
                                    <tr>
                                        <td style="" colspan="2">
                                            ...
                                            <select id="ddlUserRelationship" style="width: 71%" class="relation"></select>
                                        </td>
                                        <td style="">
            ...
            <div class="box box-primary" style="background: none">
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="text-align: center; margin-top: 10px">
                        <input type="button" class="col-sm-6 btn btnNewColor" style="margin: 0 auto" value="Add another Contact" id="btnAddanotherContact" />
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; width: 50%;">
                                    <input type="button" class="btn btnNewColor" id="btnIn" style="background-color: #3B5998" value="In" /></td>
                                <td style="width: 50%;">
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="../../AppJs/TenantAllJs/TenantProfile_DashBoard.js"></script>
    <style type="text/css">
