<%@ Page Title="EProperty365: Residential Ad response Site template Login" Language="C#" AutoEventWireup="true" CodeBehind="ResidentialAddResponceTemplate_Login.aspx.cs" Inherits="eProperty.Pages.Resident.ResidentialAddResponceTemplate_Login" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>EProperty365: Residential Ad response Site template Login</title>
...
<body class="hold-transition skin-blue sidebar-mini fixed">
        ...
        <div class="content-wrapper">
                                     ...
                                     <div class="col-md-12">
                                        ...
                                        <img alt="" src="https://www.eproperty365.net/Images/For_Rent_241_81.jpg" class="img img-responsive" />
                                          ...
                                          <div class="col-md-2"  style="float: left;">
                                              <h6>MONTHLY RENTAL AMOUNT $0.00</h6>
                                             </div>
                                    </div>
                                        ...
                                        <div class="col-md-4" style="float: left">
                                            ...
                                            <div class="col-md-12" style="float: left; border: 1px solid; margin: 10px 0px 5px 0px; padding: 10px;">
                                              ...
                                              <div class="col-md-12" style="float: left;">
                                                ...
                                                <div class="col-sm-6" style="float: left">
                                                    <label class="col-sm-12 control-label" id="BroerEmail"></label>
                                                </div>
                                                  </div>
                                                ...
                                                <div class="col-sm-6" style="float: left">
                                                    <label f class="col-sm-12 control-label" style="margin-top: 7px" id="AgentName"></label>
                                                </div>
                                                  </div>
                                            ...
                                            <div class="col-md-12" style="float: left">
                                                <input type="button" value="Apply" style="width: 100%; font-size: 15px;" id="btnApply" class="btn btnNewColor" />
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-md-12">
                                                               <div class="col-md-10" style="margin: 0 auto">
                                                                       ...
                                                                       <div class="col-md-6" style="float: left">
                                                                         <input  type="text" id="txtTenantFirstName" placeholder="Enter First Name" class="col-sm-12 form-control" />
                                                                       </div>
                                                                       <div class="col-md-6" style="float: left; padding-right: 0px;">
                                                                           <input  type="text" id="txtTenantLastName" placeholder="Enter Last Name" class="col-sm-12 form-control" />
                                                                           </div>
                                                                        <div class="col-md-12" style="float: left">
                                                                            <input  type="text" id="txtTenantPhoneNumber" placeholder="Enter Phone Number" class="col-sm-12 form-control" />
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12" style="margin-top: 6px;float: left">
                                                                            <input type="button" class="btn btnNewColor col-sm-12" id="btnFillApp" style="background-color: #3B5998" value="Sign in & Fill out Application for Property Rental" />
                                                                        </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <footer>                
                <ul class="rent_footer">
                    <li>
                        <a href="/">
                            <img src="https://www.eproperty365.com/Images/logo.png" width="100" class="img img-responsive" alt="Logo"/>
                        </a>
                    </li>
    ...
    <script type="text/javascript">
                    ...
                    function (result) {
                        ...
                        $.each(lstofCountry, function (i, obj) {
                            ...
                            content += '<div class="col-md-3" style="float:left;margin-bottom: 10px;">' +
                                '<div style="border: 1px solid #CBCBCB;box-shadow: 0px 0px 1px 0px;float: left;padding: 3px;margin-bottom: 8px;width:100%">' +
                                '<img style="width: 205px;height: 177px;float: left;" src="' + obj.ImagePath + '"/>' +
                                '</div>' +
                    ...
                    function (result) {
                        ...
                        if (lstofFeatureName != null) {
                            $.each(lstofFeatureName, function (i, obj) {
                                ...
                                content += "<td><span class='col-sm-12' form-check-inline'><input id='" + obj.Id + "' name='chkFeatureName' class='chkf' type='checkbox'>" +
            ...
            $.ajax({
                ...
                success:
                    function (result) {
                        ...
                        if (res == 'true') {
                            notify('sucess', "You Application submitted successfully.You will receive text from the agents to confirm or set up your appointment ");
                        } else {
        ...
        $(document).on('click', '#btnFirstTimeSignIn', function (parameters) {
            ...
            if (Validate()) {               
                ...
                $.ajax({
                    ...
                    success:
                        function (result) {
                            ...
                            var content = "";
                            if (lstofFeatureName != null) {
                                if(lstofFeatureName.Email == $.trim($("#txtTenantEmail").val()))
                                {
                                    notify('danger', "Email already taken for this unit !!");
                                }
                                else if (lstofFeatureName.Status == "Approved")
                                {
                                    notify('danger', "This unit is rented !!");
                                }
                                else if (lstofFeatureName.Status == "Complete")
                                {
                                    notify('danger', "This unit is under process with another Tenant !!");
                                }
                                else
                                {
                                    var URL = "/Pages/Resident/ResidentialAddResponceTemplate_Login.aspx/" + "FirstTimeSignIn";
                                    var obj = {
                                        EmailId: $("#txtTenantEmail").val(),
                                        FirstName: $("#txtTenantFirstName").val(),
                                        LastName: $("#txtTenantLastName").val(),
                                        PhoneNumber: $("#txtTenantPhoneNumber").val()
                                        ...
                                        if (data.d != null || data.d != "") {
                                            ...
                                            if (res != null) {
                                                if (res.isFirstSignIn == true) {
                                                    ...
                                                    var url = origin + "/Pages/Resident/ResidentialAddResponseTemplateNew.aspx?ResidentialUnitSerial=" + res.ResidentialUnitSerialId + '&&TenentId=' + res.Serial;
                                                    window.location.href = url;
                                                } else {
                                                    //ResidentialTentAddResponceStep1
                                                    var origin = window.location.origin; // Returns base URL
                                                ...
                                                notify('danger', "Registration Failed !!");
                                            }
                ...
                notify('danger', "Please fill out the Form  !!");
            }
        });

        function Validate(parameters) {
            var isresult = true;
            var Firstname = $("#txtTenantFirstName").val();
            var LastName = $("#txtTenantLastName").val();
            var Email = $("#txtTenantEmail").val();
            var Phone = $("#txtTenantPhoneNumber").val();

            if (Firstname === "undefined" || Firstname === "") {
                $("#txtTenantFirstName").css({ 'border': '1px solid red' });
                isresult = false;
            }
            else {
                $("#txtTenantFirstName").css({ 'border': '1px solid #d2d6de' });
            }

            if (LastName === "undefined" || LastName === "") {
                $("#txtTenantLastName").css({ 'border': '1px solid red' });
                isresult = false;
            }
            else {
                $("#txtTenantLastName").css({ 'border': '1px solid #d2d6de' });
            }
            ...
            if (Phone === "undefined" || Phone === "") {
                $("#txtTenantPhoneNumber").css({ 'border': '1px solid red' });
                isresult = false;
            }
            else {
                $("#txtTenantPhoneNumber").css({ 'border': '1px solid #d2d6de' });
            }
            if (isresult)
                isresult = true;
            else {
        ...
        $(document).on('click', '#btnFillApp', function (parameters) {
                ...
                $.ajax({
                    ...
                    success:
                        function (result) {
                            ...
                            var content = "";
                            if (lstofFeatureName != null) {
                                if (lstofFeatureName.Status == "Approved" && lstofFeatureName.Email != $.trim($("#txtTenantEmail").val())) {
                                    bExist = true;
                                    notify('danger', "This unit is rented !!");
                                }
                                else if (lstofFeatureName.Status == "Complete" && lstofFeatureName.Email != $.trim($("#txtTenantEmail").val())) {
                                    notify('danger', "This unit is under process with another Tenant !!");
                                }
                                else {
                                    var URL = "/Pages/Resident/ResidentialAddResponceTemplate_Login.aspx/" + "SecondTimeSignIn";
                                    var obj = {
                                        EmailId: $("#txtTenantEmail").val(),
                                        FirstName: $("#txtTenantFirstName").val(),
                                        LastName: $("#txtTenantLastName").val(),
                                    ...
                                    Basic.then((data) => {
                                        if (data.d != null || data.d != "") {
                                            var res = $.parseJSON(decodeURIComponent(data.d));
                                            if (res != null) {
                                                if (res.isFirstSignIn == true && res.Serial != "") {
                                                    var origin = window.location.origin; // Returns base URL
                                                    var url = origin + "/Pages/Resident/ResidentialTentAddResponceStep1.aspx?ResidentialUnitSerial=" + res.ResidentialUnitSerialId + '&&TenentId=' + res.Serial;
                                                    window.location.href = url;
                                                }
