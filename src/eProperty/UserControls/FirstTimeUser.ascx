<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FirstTimeUser.ascx.cs" Inherits="eProperty.UserControls.FirstTimeUser" %>
        ...
        <ul class="sidebar-menu" data-widget="tree" id="menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" id="16">
                    <li><a href="https://www.eproperty365.net/Pages/Admin/AddResidentialUnit.aspx"><i class="fa fa-circle-o"></i>Maintenance Dashboard</a></li>
            ...
            <li class="treeview ">
                ...
                <ul class="treeview-menu" id="20">
                  ...
                  <%--  <li><a href="https://www.eproperty365.net/Pages/Resident/ResidentialUnitListing.aspx"><i class="fa fa-circle-o"></i>Residential Add Template Listing </a></li>--%>
                    ...
                    <li><a href="#"><i class="fa fa-circle-o"></i>Create Tenant Account script  of existing tenant </a></li>
